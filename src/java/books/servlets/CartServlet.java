...
public class CartServlet extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        String removeAtIndex = request.getParameter("removeAtIndex");
        ...
        synchronized(session)
        {
            ...
            {
                Book selectedBook = DatabaseIO.selectBook(Integer.parseInt(bookID));
                cart.add(selectedBook);
                session.setAttribute("cart", cart);
            }
            else
            {
                int i = Integer.parseInt(removeAtIndex);
                cart.remove(i);
                session.setAttribute("cart", cart);
            }
        }
